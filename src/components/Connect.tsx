    ...
    <div className="setup">
      <div className="setup-card">
        ...
        <p className="setup-tag">
          Dependabot, but for the configuration rather than the dependencies.{" "}
          <a href="https://intentius.io/chant/cli/audit/">chant</a> audits the repositories you enrol — CI, manifests,
          Dockerfiles, cloud templates — on a schedule, and an agent opens the pull requests. You review them on GitHub;
          you never need to come back here.
        </p>
        <p className="setup-tag">
          The rounds run on your <a href="https://github.com/BinaryBourbon/fountain">Fountain</a>: one agent and one cron
          per repository. Point this at yours.
        </p>
